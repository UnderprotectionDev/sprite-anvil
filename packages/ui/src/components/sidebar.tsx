...
import { Separator } from "@sprite-anvil/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@sprite-anvil/ui/components/sheet";
import { Skeleton } from "@sprite-anvil/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@sprite-anvil/ui/components/tooltip";
import { useIsMobile } from "@sprite-anvil/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// Persist the state for server-rendered sidebar layouts.
			// biome-ignore lint/suspicious/noDocumentCookie: This first-party state cookie needs an explicit path and expiry.
